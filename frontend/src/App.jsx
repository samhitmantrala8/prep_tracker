...
const priorityPrepBlock = [
  "Compete with past contests, participate in virtual contests in the late 2022 or early 2023, especially 2022 all contests and 2023 first six months contests. And apart from that, you can prepare previous year questions of system design by adding AI features and behavioral questions.",
  ...
  return (
    <main className="min-h-screen px-4 py-5 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <section className="mb-5 rounded-lg border border-teal-200 bg-white p-5 shadow-sm">
          <div className="flex items-start gap-3">
            <Sparkles className="mt-0.5 shrink-0 text-teal-700" size={22} />
            <div className="min-w-0">
              <h2 className="text-base font-semibold text-slate-950">Priority Prep Block</h2>
              <div className="mt-3 space-y-3 text-sm leading-6 text-slate-700">
                {priorityPrepBlock.map((item) => (
                  <p key={item}>{item}</p>
                ))}
              </div>
            </div>
